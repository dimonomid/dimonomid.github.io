...
T\+Neo\+Kernel also offers a very useful feature\+: connecting an event group to other kernel objects. Read \hyperlink{tnkernel_diff_tnkernel_new_features__eventgrp_conn}{below}.
...
T\+Neo\+Kernel (since \hyperlink{changelog_changelog_v1_03}{v1.\+03}) offers a solution\+: an event group can be connected to other kernel objects, and these objects will maintain certain flags inside that event group automatically.
