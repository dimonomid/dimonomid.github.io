...
\begin{DoxyItemize}
\item wait for a message from the queue(s) plus wait for some application-\/dependent event;
...
Definition at line 138 of file tn\+\_\+eventgrp.\+h.
...
\hline
{\em p\+\_\+flags\+\_\+pattern} & Pointer to the {\ttfamily T\+N\+\_\+\+U\+Word} variable in which actual event pattern that caused task to stop waiting will be stored. May be {\ttfamily N\+U\+L\+L}. \\
\hline
