...
typedef void( \hyperlink{tn__sys_8h_ae8fd9ea5f9f265e638b56917bf1a5767}{T\+N\+\_\+\+C\+B\+Deadlock} )(\hyperlink{tn__common_8h_ae4cc35dcc70810fa972cc8a5185a28fa}{B\+O\+O\+L} active, struct \hyperlink{structTN__Mutex}{T\+N\+\_\+\+Mutex} $\ast$mutex, struct \hyperlink{structTN__Task}{T\+N\+\_\+\+Task} $\ast$task)
...
void \hyperlink{tn__sys_8h_ad87fac29a918ffc1cae40f2b6d67e369}{tn\+\_\+sys\+\_\+time\+\_\+set} (unsigned int value)
\begin{DoxyCompactList}\small\item\em Set system ticks count. \end{DoxyCompactList}\item 
void \hyperlink{tn__sys_8h_aaa4a5c2feb4a0db5993b81dde496edc3}{tn\+\_\+callback\+\_\+deadlock\+\_\+set} (\hyperlink{tn__sys_8h_ae8fd9ea5f9f265e638b56917bf1a5767}{T\+N\+\_\+\+C\+B\+Deadlock} $\ast$cb)
...
static \hyperlink{tn__common_8h_ae4cc35dcc70810fa972cc8a5185a28fa}{B\+O\+O\+L} \hyperlink{tn__sys_8h_ad87f45a4a385f68f9492ba48365c00e0}{tn\+\_\+is\+\_\+task\+\_\+context} (void)
...
static \hyperlink{tn__common_8h_ae4cc35dcc70810fa972cc8a5185a28fa}{B\+O\+O\+L} \hyperlink{tn__sys_8h_a797d5a13800d4da9581abaa13e506854}{tn\+\_\+is\+\_\+isr\+\_\+context} (void)
...
Definition at line 141 of file tn\+\_\+sys.\+h.
...
Definition at line 156 of file tn\+\_\+sys.\+h.

\hypertarget{tn__sys_8h_ae8fd9ea5f9f265e638b56917bf1a5767}{\index{tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}!T\+N\+\_\+\+C\+B\+Deadlock@{T\+N\+\_\+\+C\+B\+Deadlock}}
\index{T\+N\+\_\+\+C\+B\+Deadlock@{T\+N\+\_\+\+C\+B\+Deadlock}!tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}}
\subsubsection[{T\+N\+\_\+\+C\+B\+Deadlock}]{\setlength{\rightskip}{0pt plus 5cm}typedef void( T\+N\+\_\+\+C\+B\+Deadlock)({\bf B\+O\+O\+L} active, struct {\bf T\+N\+\_\+\+Mutex} $\ast$mutex, struct {\bf T\+N\+\_\+\+Task} $\ast$task)}}\label{tn__sys_8h_ae8fd9ea5f9f265e638b56917bf1a5767}
...
{\em active} & if {\ttfamily T\+R\+U\+E}, deadlock becomes active, otherwise it becomes inactive (say, if task stopped waiting for mutex because of timeout) \\
\hline
...
Definition at line 171 of file tn\+\_\+sys.\+h.
...
Definition at line 79 of file tn\+\_\+sys.\+h.
...
Definition at line 95 of file tn\+\_\+sys.\+h.
...
\begin{DoxyParams}{Parameters}
{\em idle\+\_\+task\+\_\+stack} & Pointer to array for idle task stack. User must either use the macro {\ttfamily \hyperlink{tn__tasks_8h_a120e01d9dddd21ac11827595e88d7c36}{T\+N\+\_\+\+T\+A\+S\+K\+\_\+\+S\+T\+A\+C\+K\+\_\+\+D\+E\+F()}} for the definition of stack array, or allocate it manually as an array of {\ttfamily \hyperlink{tn__arch__example_8h_ab80cba0fe9ffcd9011d53dfeb9e39bf4}{T\+N\+\_\+\+U\+Word}} with {\ttfamily \hyperlink{tn__arch__example_8h_ae245dddb19cd7c12b7038a62d576fafa}{T\+N\+\_\+\+A\+R\+C\+H\+\_\+\+S\+T\+K\+\_\+\+A\+T\+T\+R\+\_\+\+B\+E\+F\+O\+R\+E}} and {\ttfamily \hyperlink{tn__arch__example_8h_ab082613959b539182b8b47bc87d18d6a}{T\+N\+\_\+\+A\+R\+C\+H\+\_\+\+S\+T\+K\+\_\+\+A\+T\+T\+R\+\_\+\+A\+F\+T\+E\+R}} macros. \\
\hline
...
\hline
{\em int\+\_\+stack} & Pointer to array for interrupt stack. User must either use the macro {\ttfamily \hyperlink{tn__tasks_8h_a120e01d9dddd21ac11827595e88d7c36}{T\+N\+\_\+\+T\+A\+S\+K\+\_\+\+S\+T\+A\+C\+K\+\_\+\+D\+E\+F()}} for the definition of stack array, or allocate it manually as an array of {\ttfamily \hyperlink{tn__arch__example_8h_ab80cba0fe9ffcd9011d53dfeb9e39bf4}{T\+N\+\_\+\+U\+Word}} with {\ttfamily \hyperlink{tn__arch__example_8h_ae245dddb19cd7c12b7038a62d576fafa}{T\+N\+\_\+\+A\+R\+C\+H\+\_\+\+S\+T\+K\+\_\+\+A\+T\+T\+R\+\_\+\+B\+E\+F\+O\+R\+E}} and {\ttfamily \hyperlink{tn__arch__example_8h_ab082613959b539182b8b47bc87d18d6a}{T\+N\+\_\+\+A\+R\+C\+H\+\_\+\+S\+T\+K\+\_\+\+A\+T\+T\+R\+\_\+\+A\+F\+T\+E\+R}} macros. \\
\hline
...
\hline
{\em cb\+\_\+user\+\_\+task\+\_\+create} & Callback function that should create initial user's task (see \hyperlink{tn__sys_8h_a94f785ff88dfca8746f34de59784883d}{T\+N\+\_\+\+C\+B\+User\+Task\+Create}) \\
\hline
{\em cb\+\_\+idle} & Callback function repeatedly called from idle task. \\
\hline
\end{DoxyParams}
...
\begin{DoxyReturn}{Returns}
Current system ticks count. Note that this value does {\bfseries not} affect any of the internal T\+Neo\+Kernel routines, it is just incremented each system tick (i.\+e. in {\ttfamily \hyperlink{tn__sys_8h_a944d96c7a5d442d271115b6cb22a085b}{tn\+\_\+tick\+\_\+int\+\_\+processing()}}) and is returned to user by {\ttfamily \hyperlink{tn__sys_8h_a8d2170986218026c105ed4656f5cd0eb}{tn\+\_\+sys\+\_\+time\+\_\+get()}}.
\end{DoxyReturn}
It is not used by T\+Neo\+Kernel itself at all. \hypertarget{tn__sys_8h_ad87fac29a918ffc1cae40f2b6d67e369}{\index{tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}!tn\+\_\+sys\+\_\+time\+\_\+set@{tn\+\_\+sys\+\_\+time\+\_\+set}}
\index{tn\+\_\+sys\+\_\+time\+\_\+set@{tn\+\_\+sys\+\_\+time\+\_\+set}!tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}}
\subsubsection[{tn\+\_\+sys\+\_\+time\+\_\+set}]{\setlength{\rightskip}{0pt plus 5cm}void tn\+\_\+sys\+\_\+time\+\_\+set (
\begin{DoxyParamCaption}
\item[{unsigned int}]{value}
\end{DoxyParamCaption}
)}}\label{tn__sys_8h_ad87fac29a918ffc1cae40f2b6d67e369}


Set system ticks count. 

Note that this value does {\bfseries not} affect any of the internal T\+Neo\+Kernel routines, it is just incremented each system tick (i.\+e. in {\ttfamily \hyperlink{tn__sys_8h_a944d96c7a5d442d271115b6cb22a085b}{tn\+\_\+tick\+\_\+int\+\_\+processing()}}) and is returned to user by {\ttfamily \hyperlink{tn__sys_8h_a8d2170986218026c105ed4656f5cd0eb}{tn\+\_\+sys\+\_\+time\+\_\+get()}}.

It is not used by T\+Neo\+Kernel itself at all.

  \includegraphics{../../images/attr_call_task.png}    \includegraphics{../../images/attr_call_int.png}  
\footnotesize {\itshape (refer to \hyperlink{legend}{Legend} for details)}
\normalsize  \hypertarget{tn__sys_8h_aaa4a5c2feb4a0db5993b81dde496edc3}{\index{tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}!tn\+\_\+callback\+\_\+deadlock\+\_\+set@{tn\+\_\+callback\+\_\+deadlock\+\_\+set}}
...
{\bfseries Note\+:} this function should be called before {\ttfamily \hyperlink{tn__sys_8h_a62ab25d9d8ca01c02d368968f19e49bf}{tn\+\_\+sys\+\_\+start()}}
...
{\ttfamily \hyperlink{tn__sys_8h_ae8fd9ea5f9f265e638b56917bf1a5767}{T\+N\+\_\+\+C\+B\+Deadlock}} for callback function prototype 
\end{DoxySeeAlso}
...
\end{DoxySeeAlso}
\hypertarget{tn__sys_8h_ad87f45a4a385f68f9492ba48365c00e0}{\index{tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}!tn\+\_\+is\+\_\+task\+\_\+context@{tn\+\_\+is\+\_\+task\+\_\+context}}
\index{tn\+\_\+is\+\_\+task\+\_\+context@{tn\+\_\+is\+\_\+task\+\_\+context}!tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}}
\subsubsection[{tn\+\_\+is\+\_\+task\+\_\+context}]{\setlength{\rightskip}{0pt plus 5cm}static {\bf B\+O\+O\+L} tn\+\_\+is\+\_\+task\+\_\+context (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{tn__sys_8h_ad87f45a4a385f68f9492ba48365c00e0}
...
\begin{DoxyReturn}{Returns}
{\ttfamily T\+R\+U\+E} if current system context is {\ttfamily \hyperlink{tn__sys_8h_a54b0c697dfdb3b59e7bcc6eb7badda51ab78bafeb369a85700f793a7375e38ec6}{T\+N\+\_\+\+C\+O\+N\+T\+E\+X\+T\+\_\+\+T\+A\+S\+K}}, {\ttfamily F\+A\+L\+S\+E} otherwise.
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
{\ttfamily \hyperlink{tn__sys_8h_ac3233931746c9d8b84ebd34a2a3a468a}{tn\+\_\+sys\+\_\+context\+\_\+get()}} 
...
Definition at line 364 of file tn\+\_\+sys.\+h.

\hypertarget{tn__sys_8h_a797d5a13800d4da9581abaa13e506854}{\index{tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}!tn\+\_\+is\+\_\+isr\+\_\+context@{tn\+\_\+is\+\_\+isr\+\_\+context}}
\index{tn\+\_\+is\+\_\+isr\+\_\+context@{tn\+\_\+is\+\_\+isr\+\_\+context}!tn\+\_\+sys.\+h@{tn\+\_\+sys.\+h}}
\subsubsection[{tn\+\_\+is\+\_\+isr\+\_\+context}]{\setlength{\rightskip}{0pt plus 5cm}static {\bf B\+O\+O\+L} tn\+\_\+is\+\_\+isr\+\_\+context (
\begin{DoxyParamCaption}
\item[{void}]{}
\end{DoxyParamCaption}
)\hspace{0.3cm}{\ttfamily [inline]}, {\ttfamily [static]}}}\label{tn__sys_8h_a797d5a13800d4da9581abaa13e506854}
...
\begin{DoxyReturn}{Returns}
{\ttfamily T\+R\+U\+E} if current system context is {\ttfamily \hyperlink{tn__sys_8h_a54b0c697dfdb3b59e7bcc6eb7badda51a4b0defef531f47e8cf5dc274355b6626}{T\+N\+\_\+\+C\+O\+N\+T\+E\+X\+T\+\_\+\+I\+S\+R}}, {\ttfamily F\+A\+L\+S\+E} otherwise.
\end{DoxyReturn}
\begin{DoxySeeAlso}{See also}
{\ttfamily \hyperlink{tn__sys_8h_ac3233931746c9d8b84ebd34a2a3a468a}{tn\+\_\+sys\+\_\+context\+\_\+get()}} 
...
Definition at line 383 of file tn\+\_\+sys.\+h.
