Very brief explanation of the essential things I don't like in the T\+N\+Kernel code.\hypertarget{why_reimplement_why_reimplement__one_exit_point}{}\section{One entry point, one exit point}\label{why_reimplement_why_reimplement__one_exit_point}
...
If you look closely, you can see that if wrong params were given, {\ttfamily \hyperlink{tn__oldsymbols_8h_a35ec519d54f884d84c5814f49f00a22b}{T\+E\+R\+R\+\_\+\+W\+R\+O\+N\+G\+\_\+\+P\+A\+R\+A\+M}} is returned, and {\bfseries interrupts remain disabled}. If we follow the {\itshape one entry point, one exit point} rule, this bug is much less likely to happen.\hypertarget{why_reimplement_why_reimplement__dont_repeat_yourself}{}\section{Don't repeat yourself}\label{why_reimplement_why_reimplement__dont_repeat_yourself}
...
\}
\end{DoxyCode}
\hypertarget{why_reimplement_why_reimplement__linked_lists}{}\section{Code for doubly-\/linked lists}\label{why_reimplement_why_reimplement__linked_lists}
