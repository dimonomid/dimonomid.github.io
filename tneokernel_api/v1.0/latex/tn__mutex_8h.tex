...
Mutex features in T\+Neo\+Kernel\+:
...
The priority inheritance protocol solves the priority inversions problem but doesn't prevents deadlocks, although the kernel can notify you if a deadlock has occured (see {\ttfamily \hyperlink{tn__cfg__default_8h_a6ed3ec7b0d4338e7f60dde86b7ea5fa4}{T\+N\+\_\+\+M\+U\+T\+E\+X\+\_\+\+D\+E\+A\+D\+L\+O\+C\+K\+\_\+\+D\+E\+T\+E\+C\+T}}).
...
enum \hyperlink{tn__common_8h_aa43bd3da1ad4c1e61224b5f23b369876}{T\+N\+\_\+\+R\+Code} \hyperlink{tn__mutex_8h_a6021c483422dfc7221353f4b8ee16e06}{tn\+\_\+mutex\+\_\+lock} (struct \hyperlink{structTN__Mutex}{T\+N\+\_\+\+Mutex} $\ast$mutex, \hyperlink{tn__common_8h_a34c07c1fa20ae71d17817d28a41957fe}{T\+N\+\_\+\+Timeout} timeout)
...
\begin{DoxyCompactList}\small\item\em The same as {\ttfamily \hyperlink{tn__mutex_8h_a6021c483422dfc7221353f4b8ee16e06}{tn\+\_\+mutex\+\_\+lock()}} with zero timeout. \end{DoxyCompactList}\item 
...
\end{DoxyItemize}
\end{DoxyReturn}
\hypertarget{tn__mutex_8h_a6021c483422dfc7221353f4b8ee16e06}{\index{tn\+\_\+mutex.\+h@{tn\+\_\+mutex.\+h}!tn\+\_\+mutex\+\_\+lock@{tn\+\_\+mutex\+\_\+lock}}
...
\end{DoxyParamCaption}
)}}\label{tn__mutex_8h_a6021c483422dfc7221353f4b8ee16e06}
...
\item If the mutex is locked by different task, behavior depends on {\ttfamily timeout} value\+: refer to {\ttfamily \hyperlink{tn__common_8h_a34c07c1fa20ae71d17817d28a41957fe}{T\+N\+\_\+\+Timeout}}.
\end{DoxyItemize}
...
The same as {\ttfamily \hyperlink{tn__mutex_8h_a6021c483422dfc7221353f4b8ee16e06}{tn\+\_\+mutex\+\_\+lock()}} with zero timeout. 
