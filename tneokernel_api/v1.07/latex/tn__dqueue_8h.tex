...
\begin{DoxyCompactList}\small\item\em The same as {\ttfamily \hyperlink{tn__dqueue_8h_a043dd3133a57489d7d10f53be6939957}{tn\+\_\+queue\+\_\+send()}} with zero timeout, but for using in the I\+S\+R. \end{DoxyCompactList}\item 
...
\begin{DoxyCompactList}\small\item\em The same as {\ttfamily \hyperlink{tn__dqueue_8h_ab47ed49af7dffc5a71eaabd25422d0e4}{tn\+\_\+queue\+\_\+receive()}} with zero timeout, but for using in the I\+S\+R. \end{DoxyCompactList}\item 
...
\hline
{\em data\+\_\+fifo} & pointer to already allocated array of {\ttfamily void $\ast$} to store data queue items. Can be {\ttfamily \hyperlink{tn__common_8h_adbf9c425147511997eb1396c4afeac40}{T\+N\+\_\+\+N\+U\+L\+L}}. \\
\hline
...
All tasks that wait for writing to or reading from the queue become runnable with {\ttfamily \hyperlink{tn__common_8h_aa43bd3da1ad4c1e61224b5f23b369876a3252967d2fdefcfbd4eb720ed4663d84}{T\+N\+\_\+\+R\+C\+\_\+\+D\+E\+L\+E\+T\+E\+D}} code returned.
...
\end{DoxyItemize}
\end{DoxyReturn}
\hypertarget{tn__dqueue_8h_a043dd3133a57489d7d10f53be6939957}{\index{tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}!tn\+\_\+queue\+\_\+send@{tn\+\_\+queue\+\_\+send}}
...
\end{DoxyParamCaption}
)}}\label{tn__dqueue_8h_a043dd3133a57489d7d10f53be6939957}
...
If there are no tasks in the data queue's {\ttfamily wait\+\_\+receive} list, parameter {\ttfamily p\+\_\+data} is placed to the tail of data F\+I\+F\+O. If the data F\+I\+F\+O is full, behavior depends on the {\ttfamily timeout} value\+: refer to {\ttfamily \hyperlink{tn__common_8h_ac885b63d00c063de61cdbd80bf26d8aa}{T\+N\+\_\+\+Tick\+Cnt}}.
...
The same as {\ttfamily \hyperlink{tn__dqueue_8h_a043dd3133a57489d7d10f53be6939957}{tn\+\_\+queue\+\_\+send()}} with zero timeout, but for using in the I\+S\+R. 

  \includegraphics{attr_call_int.png}    \includegraphics{attr_call_ct_sw.png}  
\footnotesize {\itshape (refer to \hyperlink{legend}{Legend} for details)}
\normalsize  \hypertarget{tn__dqueue_8h_ab47ed49af7dffc5a71eaabd25422d0e4}{\index{tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}!tn\+\_\+queue\+\_\+receive@{tn\+\_\+queue\+\_\+receive}}
...
\item[{{\bf T\+N\+\_\+\+Tick\+Cnt}}]{timeout}
\end{DoxyParamCaption}
)}}\label{tn__dqueue_8h_ab47ed49af7dffc5a71eaabd25422d0e4}
...
The same as {\ttfamily \hyperlink{tn__dqueue_8h_ab47ed49af7dffc5a71eaabd25422d0e4}{tn\+\_\+queue\+\_\+receive()}} with zero timeout, but for using in the I\+S\+R. 

  \includegraphics{attr_call_int.png}    \includegraphics{attr_call_ct_sw.png}  
\footnotesize {\itshape (refer to \hyperlink{legend}{Legend} for details)}
\normalsize  \hypertarget{tn__dqueue_8h_af541f16598e13f980ddc2482e6af6044}{\index{tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}!tn\+\_\+queue\+\_\+free\+\_\+items\+\_\+cnt\+\_\+get@{tn\+\_\+queue\+\_\+free\+\_\+items\+\_\+cnt\+\_\+get}}
\index{tn\+\_\+queue\+\_\+free\+\_\+items\+\_\+cnt\+\_\+get@{tn\+\_\+queue\+\_\+free\+\_\+items\+\_\+cnt\+\_\+get}!tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}}
\subsubsection[{tn\+\_\+queue\+\_\+free\+\_\+items\+\_\+cnt\+\_\+get}]{\setlength{\rightskip}{0pt plus 5cm}int tn\+\_\+queue\+\_\+free\+\_\+items\+\_\+cnt\+\_\+get (
\begin{DoxyParamCaption}
\item[{struct {\bf T\+N\+\_\+\+D\+Queue} $\ast$}]{dque}
\end{DoxyParamCaption}
)}}\label{tn__dqueue_8h_af541f16598e13f980ddc2482e6af6044}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Number of free items in the queue, or -\/1 if wrong params were given (the check is performed if only {\ttfamily \hyperlink{tn__cfg__default_8h_a1f197294df3276fec431930545acafd5}{T\+N\+\_\+\+C\+H\+E\+C\+K\+\_\+\+P\+A\+R\+A\+M}} is non-\/zero) 
\end{DoxyReturn}
\hypertarget{tn__dqueue_8h_aa17fd667cab2e4a41d9e89b8cba603cd}{\index{tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}!tn\+\_\+queue\+\_\+used\+\_\+items\+\_\+cnt\+\_\+get@{tn\+\_\+queue\+\_\+used\+\_\+items\+\_\+cnt\+\_\+get}}
\index{tn\+\_\+queue\+\_\+used\+\_\+items\+\_\+cnt\+\_\+get@{tn\+\_\+queue\+\_\+used\+\_\+items\+\_\+cnt\+\_\+get}!tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}}
\subsubsection[{tn\+\_\+queue\+\_\+used\+\_\+items\+\_\+cnt\+\_\+get}]{\setlength{\rightskip}{0pt plus 5cm}int tn\+\_\+queue\+\_\+used\+\_\+items\+\_\+cnt\+\_\+get (
\begin{DoxyParamCaption}
\item[{struct {\bf T\+N\+\_\+\+D\+Queue} $\ast$}]{dque}
\end{DoxyParamCaption}
)}}\label{tn__dqueue_8h_aa17fd667cab2e4a41d9e89b8cba603cd}
...
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
Number of used (non-\/free) items in the queue, or -\/1 if wrong params were given (the check is performed if only {\ttfamily \hyperlink{tn__cfg__default_8h_a1f197294df3276fec431930545acafd5}{T\+N\+\_\+\+C\+H\+E\+C\+K\+\_\+\+P\+A\+R\+A\+M}} is non-\/zero) 
\end{DoxyReturn}
\hypertarget{tn__dqueue_8h_ad5d94cf59bebcbf245249896751bd902}{\index{tn\+\_\+dqueue.\+h@{tn\+\_\+dqueue.\+h}!tn\+\_\+queue\+\_\+eventgrp\+\_\+connect@{tn\+\_\+queue\+\_\+eventgrp\+\_\+connect}}
