...
\begin{DoxyItemize}
\item Function is called from an I\+S\+R context (namely, from {\itshape \hyperlink{time_ticks}{system timer}} I\+S\+R, by the {\ttfamily \hyperlink{tn__sys_8h_aa44d297639e0520420890ef2bb7e2c1c}{tn\+\_\+tick\+\_\+int\+\_\+processing()}});
...
When timer fires, the user-\/provided function is called. Be aware of the following\+:
\begin{DoxyItemize}
\item Function is called from I\+S\+R context (namely, from {\itshape \hyperlink{time_ticks}{system timer}} I\+S\+R, by the {\ttfamily \hyperlink{tn__sys_8h_aa44d297639e0520420890ef2bb7e2c1c}{tn\+\_\+tick\+\_\+int\+\_\+processing()}});
\item Function is called with global interrupts disabled.
\end{DoxyItemize}
...
\item It might be {\ttfamily 0}; in this case, it's {\itshape already} time to call {\ttfamily \hyperlink{tn__sys_8h_aa44d297639e0520420890ef2bb7e2c1c}{tn\+\_\+tick\+\_\+int\+\_\+processing()}}. You might want to set interrupt request bit then, in order to get to it as soon as possible.
...
Definition at line 270 of file tn\+\_\+timer.\+h.
...
Definition at line 282 of file tn\+\_\+timer.\+h.
