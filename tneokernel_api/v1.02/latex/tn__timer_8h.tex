...
If you need to repeatedly wake up particular task, you can create semaphore which you should \hyperlink{tn__sem_8h_a6bf88a78f4f8b2799f72ee671b52ed97}{wait for} in the task, and \hyperlink{tn__sem_8h_a215fd97b86fc63192106bb30b0574d14}{signal} in the timer callback (remember that you should use {\ttfamily \hyperlink{tn__sem_8h_a215fd97b86fc63192106bb30b0574d14}{tn\+\_\+sem\+\_\+isignal()}} in this callback, since it is called from an I\+S\+R).
...
In the spirit of T\+Neo\+Kernel, timers are as lightweight as possible. That's why there is only one type of timer\+: the single-\/shot timer. If you need your timer to fire repeatedly, you can easily restart it from the timer function by the {\ttfamily \hyperlink{tn__timer_8h_ad2e783b412081d6d266a15e0ce733ab3}{tn\+\_\+timer\+\_\+start()}}, so it's not a problem.

When timer fires, the user-\/provided function is called. Be aware of the following\+:


\begin{DoxyItemize}
\item Function is called from an I\+S\+R context (namely, from {\itshape \hyperlink{quick_guide_time_ticks}{system timer}} I\+S\+R, by the {\ttfamily \hyperlink{tn__sys_8h_a944d96c7a5d442d271115b6cb22a085b}{tn\+\_\+tick\+\_\+int\+\_\+processing()}});
...
\item The function should not enable interrupts unconditionally. Consider using {\ttfamily \hyperlink{tn__arch_8h_a010a50388c4cdca7cdda8b82b1c17563}{tn\+\_\+arch\+\_\+sr\+\_\+save\+\_\+int\+\_\+dis()}} and {\ttfamily \hyperlink{tn__arch_8h_a4662406a6972e7f4d99e8d8dd90218e0}{tn\+\_\+arch\+\_\+sr\+\_\+restore()}} if you need.
\end{DoxyItemize}

See {\ttfamily \hyperlink{tn__timer_8h_a98be38210cd5a636dc4170e087ea0e67}{T\+N\+\_\+\+Timer\+Func}} for the prototype of the function that could be scheduled.\hypertarget{tn__timer_8h_timers_implementation}{}\subsection{Implementation of timers}\label{tn__timer_8h_timers_implementation}
...
So, T\+Neo\+Kernel's implementation\+:
...
The {\ttfamily N} in the T\+Neo\+Kernel is configured by the compile-\/time option {\ttfamily \hyperlink{tn__cfg__default_8h_afef2a6ec1baa81edaa979024af0c924a}{T\+N\+\_\+\+T\+I\+C\+K\+\_\+\+L\+I\+S\+T\+S\+\_\+\+C\+N\+T}}. 
...
\begin{DoxyCompactList}\small\item\em Prototype of the function that should be called by timer. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
enum \hyperlink{tn__common_8h_aa43bd3da1ad4c1e61224b5f23b369876}{T\+N\+\_\+\+R\+Code} \hyperlink{tn__timer_8h_ad2e783b412081d6d266a15e0ce733ab3}{tn\+\_\+timer\+\_\+start} (struct \hyperlink{structTN__Timer}{T\+N\+\_\+\+Timer} $\ast$timer, \hyperlink{tn__common_8h_a34c07c1fa20ae71d17817d28a41957fe}{T\+N\+\_\+\+Timeout} timeout)
...
enum \hyperlink{tn__common_8h_aa43bd3da1ad4c1e61224b5f23b369876}{T\+N\+\_\+\+R\+Code} \hyperlink{tn__timer_8h_a59b7c3164cb5c5520e3b329e749fac20}{tn\+\_\+timer\+\_\+is\+\_\+active} (struct \hyperlink{structTN__Timer}{T\+N\+\_\+\+Timer} $\ast$timer, \hyperlink{tn__common_8h_ae4cc35dcc70810fa972cc8a5185a28fa}{B\+O\+O\+L} $\ast$p\+\_\+is\+\_\+active)
\begin{DoxyCompactList}\small\item\em Returns whether given timer is active or inactive. \end{DoxyCompactList}\item 
enum \hyperlink{tn__common_8h_aa43bd3da1ad4c1e61224b5f23b369876}{T\+N\+\_\+\+R\+Code} \hyperlink{tn__timer_8h_a6b4b96ba5e549c09f8b6364b04534f6d}{tn\+\_\+timer\+\_\+time\+\_\+left} (struct \hyperlink{structTN__Timer}{T\+N\+\_\+\+Timer} $\ast$timer, \hyperlink{tn__common_8h_a34c07c1fa20ae71d17817d28a41957fe}{T\+N\+\_\+\+Timeout} $\ast$p\+\_\+time\+\_\+left)
\begin{DoxyCompactList}\small\item\em Returns how many {\itshape \hyperlink{quick_guide_time_ticks}{system timer}} ticks (at most) is left for the timer to expire. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
When timer fires, the user-\/provided function is called. Be aware of the following\+:
\begin{DoxyItemize}
\item Function is called from I\+S\+R context (namely, from {\itshape \hyperlink{quick_guide_time_ticks}{system timer}} I\+S\+R, by the {\ttfamily \hyperlink{tn__sys_8h_a944d96c7a5d442d271115b6cb22a085b}{tn\+\_\+tick\+\_\+int\+\_\+processing()}});
\item Function is called with global interrupts disabled.
\end{DoxyItemize}
...
Definition at line 197 of file tn\+\_\+timer.\+h.
...
\hline
{\em func} & Function to be called by timer, can't be {\ttfamily N\+U\+L\+L}. See {\ttfamily \hyperlink{tn__timer_8h_a98be38210cd5a636dc4170e087ea0e67}{T\+N\+\_\+\+Timer\+Func()}} \\
\hline
...
\end{DoxyItemize}
\end{DoxyReturn}
\hypertarget{tn__timer_8h_ad2e783b412081d6d266a15e0ce733ab3}{\index{tn\+\_\+timer.\+h@{tn\+\_\+timer.\+h}!tn\+\_\+timer\+\_\+start@{tn\+\_\+timer\+\_\+start}}
...
\end{DoxyParamCaption}
)}}\label{tn__timer_8h_ad2e783b412081d6d266a15e0ce733ab3}
...
\end{DoxyItemize}
\end{DoxyReturn}
\hypertarget{tn__timer_8h_a59b7c3164cb5c5520e3b329e749fac20}{\index{tn\+\_\+timer.\+h@{tn\+\_\+timer.\+h}!tn\+\_\+timer\+\_\+is\+\_\+active@{tn\+\_\+timer\+\_\+is\+\_\+active}}
...
\begin{DoxyParamCaption}
\item[{struct {\bf T\+N\+\_\+\+Timer} $\ast$}]{timer, }
\item[{{\bf B\+O\+O\+L} $\ast$}]{p\+\_\+is\+\_\+active}
\end{DoxyParamCaption}
)}}\label{tn__timer_8h_a59b7c3164cb5c5520e3b329e749fac20}
...
{\em timer} & Pointer to timer \\
\hline
{\em p\+\_\+is\+\_\+active} & Pointer to {\ttfamily \hyperlink{tn__common_8h_ae4cc35dcc70810fa972cc8a5185a28fa}{B\+O\+O\+L}} variable in which resulting value should be stored\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
...
\end{DoxyItemize}
\end{DoxyReturn}
\hypertarget{tn__timer_8h_a6b4b96ba5e549c09f8b6364b04534f6d}{\index{tn\+\_\+timer.\+h@{tn\+\_\+timer.\+h}!tn\+\_\+timer\+\_\+time\+\_\+left@{tn\+\_\+timer\+\_\+time\+\_\+left}}
...
\begin{DoxyParamCaption}
\item[{struct {\bf T\+N\+\_\+\+Timer} $\ast$}]{timer, }
\item[{{\bf T\+N\+\_\+\+Timeout} $\ast$}]{p\+\_\+time\+\_\+left}
\end{DoxyParamCaption}
)}}\label{tn__timer_8h_a6b4b96ba5e549c09f8b6364b04534f6d}


Returns how many {\itshape \hyperlink{quick_guide_time_ticks}{system timer}} ticks (at most) is left for the timer to expire. 
...
{\em timer} & Pointer to timer \\
\hline
{\em p\+\_\+time\+\_\+left} & Pointer to {\ttfamily \hyperlink{tn__common_8h_a34c07c1fa20ae71d17817d28a41957fe}{T\+N\+\_\+\+Timeout}} variable in which resulting value should be stored\\
\hline
\end{DoxyParams}
\begin{DoxyReturn}{Returns}
